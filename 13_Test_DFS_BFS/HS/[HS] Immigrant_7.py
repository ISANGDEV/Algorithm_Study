    ...
    if day % 2 == 0:
        ...
        while que:
            ...
            for i,j in vec:
                ...
                if 0<= new_x < n and 0 <= new_y < n :
                    if l<= abs(geo_1[a][b] - geo_1[new_x][new_y]) <=r and geo_1[new_x][new_y] != 101:
                        que.append([new_x,new_y])
                        count += 1
                        temp += geo_1[new_x][new_y]
                        visit[new_x][new_y] = 1
                        geo_1[new_x][new_y] = 101
        if count == 1:
            return count
        ...
        while que:
            ...
            for i,j in vec:
                ...
                new_y = b + j
                if 0<= new_x < n and 0 <= new_y < n :
                    if (l <= abs(geo_2[a][b] - geo_2[new_x][new_y]) <= r) and geo_2[new_x][new_y] != 101:
                        que.append([new_x,new_y])
                        count += 1
                        temp += geo_2[new_x][new_y]
                        visit[new_x][new_y] = 1
                        geo_2[new_x][new_y] = 101
